...
/**
 * Mobile speaker-turn fixture — kept verbatim with the web fixture in
 * `apps/web/src/components/feature/analysis/speaker-turns.fixture.ts` so
 * a single citation `(meetingId, turnId)` resolves to the same preview
 * across platforms.
 *
 * TODO(Story 2.1 follow-up): replace with a real fetch against
 * `GET /api/v1/meetings/:meetingId/speaker-turns` once the recordings +
 * transcription endpoints land.
 */
